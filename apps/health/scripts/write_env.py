...
def main() -> None:
    ...
    lines = [
        ...
        f"SINO_CLIENT_BASIC={_grep(agentservice_env, 'SINO_CLIENT_BASIC') or _grep(icancgm_env, 'SINO_CLIENT_BASIC')}",
        ...
        f"ICAN_TOKEN={_grep(agentservice_env, 'ICAN_TOKEN') or _grep(icancgm_env, 'ICAN_TOKEN')}",
        "SINO_TOKEN_CACHE_PATH=" + str(Path.home() / ".config" / "sino" / "agentservice_token.json"),
        "PORT=8090",
        "HOST=0.0.0.0",
